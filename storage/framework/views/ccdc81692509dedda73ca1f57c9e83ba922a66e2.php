...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="<?php echo e(URL('img/doctor.svg')); ?>">
      ...
      <div class="relative group">
          <div aria-hidden="true" class="absolute inset-0 rounded-xl shadow-xl transition duration-300 group-hover:scale-105 lg:group-hover:scale-110"></div>
            <div class="relative text-center space-y-4 p-6 md:p-8">
                <img src="<?php echo e(URL('img/orders.svg')); ?>" class="w-16 m-auto" width="512" height="512" >
                <h4 class="text-2xl text-gray-600 font-medium transition group-hover:text-[#044D5E]"><?php echo e($p->name); ?></h4>
                <p class="text-gray-600"><?php echo e($p->description); ?></p>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mintech/Documents/Node js/medical-appointments/resources/views/welcome.blade.php ENDPATH**/ ?>